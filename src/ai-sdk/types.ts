...
export type SupportedProvider =
	| 'openai'            // api.openai.com (uses Responses API in SDK 2.x)
	| 'openai-responses'  // Explicit OpenAI Responses API (v1/responses)
	| 'anthropic'         // api.anthropic.com (v1/messages API)
	| 'google'            // generativelanguage.googleapis.com
	| 'azure'             // *.openai.azure.com
	| 'openai-compatible'; // DeepSeek, Perplexity, OpenRouter, xAI, Meta, Ollama, etc. (Chat Completions API)
